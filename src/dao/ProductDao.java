...
public class ProductDao {
    ...
    public ArrayList<Product> findAll() {
        ...
        ResultSet rs = null;
        try {
            rs = this.connection.createStatement().executeQuery("SELECT * FROM public.product");
            while (rs.next()) {
    ...
    public boolean save(Product product) {
        String query = "INSERT INTO public.product (name,code,price,stock) VALUES (?,?,?,?)";
    ...
    public boolean update(Product product) {
        String query = "UPDATE public.product SET " + "name = ? , " + "code = ? ," + "price = ? ," + "stock = ? " + "WHERE id = ?";
